  ...
  class CrsmSlam{
    ...
    public:
      ...
      /**
        ...
        @param ocgd [double] [OC]cupancy [G]rid [D]imentionality - the width 
        and height in meters of a pixel
        @return void
       **/
      ...
      /**
        ...
        @return double Translation in x axis of laser in comparison to robot 
        center
       **/
